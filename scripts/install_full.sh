...
GIT_DIR="/home/$CURRENT_USER/smarty"

source $GIT_DIR/scripts/install_helpers.sh
...
WAYFIRE_INI="$USER_HOME_DIR/.config/wayfire.ini"
BASH_RC="$USER_HOME_DIR/.bashrc"
...
ENV_VAR_ARRAY["WALLPAPER_IMAGE"]="$GIT_DIR/resources/wallpaper/$SELECTED_MODE.png"
